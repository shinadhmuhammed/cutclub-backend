...
import { addServices, changeStatusOfStaff, createExpenses, getAllServices, getEmployees, getExpenses, getGraphResult, getMonthlyProfit, getServicesForEachStaffForToday, getUserMonthlyTotals, getWaterDetails, login, pourWater, signup } from "../controller/userController.js";
...
router.get("/employee-details/:id",authMiddleware,getUserMonthlyTotals)
